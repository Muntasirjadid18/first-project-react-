...
const teamsData = [
    ...
    {
      id: 5,
      image: require('../images/team5.jpg'),
      fbLink: 'https://www.facebook.com',
      twitterLink: 'https://www.twitter.com',
      linkedinLink: 'https://www.linkedin.com',
      name: 'Sophia Pitt',
    ...
    {
      id: 6,
      image: require('../images/team6.jpg'),
      fbLink: 'https://www.facebook.com',
      twitterLink: 'https://www.twitter.com',
      linkedinLink: 'https://www.linkedin.com',
      name: 'Taylor Lopez',
    ...
    {
      id: 7,
      image: require('../images/team7.jpg'),
      fbLink: 'https://www.facebook.com',
      twitterLink: 'https://www.twitter.com',
      linkedinLink: 'https://www.linkedin.com',
      name: 'Ryan Giggs',
    ...
    {
      id: 8,
      image: require('../images/team8.jpg'),
      fbLink: 'https://www.facebook.com',
      twitterLink: 'https://www.twitter.com',
      linkedinLink: 'https://www.linkedin.com',
      name: 'David Smith',
...
export default function AppTeams(){
    return(
        <section id='teams' className='block-team'>
             <Container fluid>
